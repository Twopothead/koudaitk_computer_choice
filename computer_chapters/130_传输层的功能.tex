...
\end{solution}
\question 以下说法错误的是（ ）。
\ding{192}．广播式网络一般只包含3层，即物理层、数据链路层、网络层
\ding{193}．Internet的核心协议是TCP/IP
\ding{194}．在Internet中，网络层的服务访问点是端口号
\par\twoch{\ding{192}、\ding{193}和\ding{194}}{只有\ding{194}}{\textcolor{red}{\ding{192}、\ding{194}}}{\ding{192}、\ding{193}}
\begin{solution}由于广播式网络并不存在路由选择问题，故没有网络层，故\ding{192}错误；Internet的核心协议是TCP/IP协议，故\ding{193}正确；在Internet中，网络层的服务访问点是IP地址，传输层的服务访问点是端口号，故\ding{194}错误。
\end{solution}
